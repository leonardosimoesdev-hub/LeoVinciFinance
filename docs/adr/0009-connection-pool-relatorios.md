...
Proposta (valor final a confirmar na Fase 4/8, após medição)
...
## Decisão (ponto de partida, sujeito a ajuste na Fase 8)
...
* Este número **não é definitivo**: será validado (e ajustado se necessário) no teste de carga da Fase 8, com throughput, latência e erros medidos e documentados.
